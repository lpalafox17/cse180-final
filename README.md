...
```
#Running 
Since you sourced the environment you can now command run:<br/> **_NOTE:_** You must first run gazeboo environment in seperate shell terminal before running this command.
